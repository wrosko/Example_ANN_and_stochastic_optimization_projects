function evaluatedPoint = BestChromosomeEquationGenerator(chromosome,cRegister,cMax)
  ...
  for i = 1:nInstructions
      ...
      tempRRegisters(i,:) = tempRRegister;
      instructionIndex = instructionIndex+1;

    
  end
%   tempRRegisters;
  evaluatedPoint = simplify(tempRRegister(1));
end
